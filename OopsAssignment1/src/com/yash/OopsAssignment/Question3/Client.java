package com.yash.OopsAssignment.Question3;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		Customer cc = new Customer(1, 333, "smita", "Pune", "07/04/1990", "05/04/1997", bb);
		...
		Customer cc2 = new Customer(2, 333, "smita", "Pune", "07/04/1990", "07/04/1990", bb);
